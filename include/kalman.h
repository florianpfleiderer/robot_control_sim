...
/**
 * @brief Convenient alias for a 1D position+velocity Kalman filter with acceleration input.
 *
 * State:   [x, v]^T
 * Control: [a]^T
 * Meas:    [x_meas]^T
...
/**
 * @brief Convenient alias for a 2D position+velocity Kalman filter with acceleration input.
 *
 * State:   [x, v_x, y, v_y]^T
 * Control: [a_x, a_y]^T
