...
[[nodiscard]] Coordinate<double> Controller::compute(
    ...
    integral_error_.x = std::clamp(
        integral_error_.x, -integral_limit_, integral_limit_);
    integral_error_.y = std::clamp(
        integral_error_.y, -integral_limit_, integral_limit_);
